...
namespace Project_Unorder.ObjectManage.CombatObjects.ProcessWindows
{
    public class ProcessWindow : MonoBehaviour
    {
        ...
        protected HealthBody _healthCompo;
        [Header("Process Setting")]
        [SerializeField] private Process[] _processes;
        ...
        public HealthBody HealthCompo => _healthCompo;
        ...
        private void Awake()
        {
            _healthCompo = GetComponent<HealthBody>();
            if (_healthCompo == null)
            {
                Debug.LogError("[Process Window] HealthBody Component not Attached");
                return;
            }
